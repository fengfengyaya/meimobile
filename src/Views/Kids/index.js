...
//			console.log(res.data.banners[0].main_title)
		...
		axios({
			url:'http://www.mei.com/appapi/silo/eventForH5?categoryId=kids&pageIndex=1&timestamp=1561776724460&summary=a1a6ad2b03d4ff52dfdc629277b41b81&platform_code=H5'
		}).then(res=>{
...
//				console.log('shuaxin')
				...
				axios({
					url:`http://www.mei.com/appapi/silo/eventForH5?categoryId=kids&pageIndex=${this.state.page}&timestamp=1561776724460&summary=a1a6ad2b03d4ff52dfdc629277b41b81&platform_code=H5`
				}).then(res=>{
//					console.log(res.data.eventList)
