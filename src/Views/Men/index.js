...
//			console.log(res.data.banners[0].main_title)
		...
		axios({
			url:'http://www.mei.com/appapi/silo/eventForH5?categoryId=men&pageIndex=1&timestamp=1561776087546&summary=b23ded8d8f74debc26d58c8cfcf23937&platform_code=H5'
		}).then(res=>{
...
//				console.log('shuaxin')
				...
				axios({
					url:`http://www.mei.com/appapi/silo/eventForH5?categoryId=men&pageIndex=${this.state.page}&timestamp=1561776087546&summary=b23ded8d8f74debc26d58c8cfcf23937&platform_code=H5`
				}).then(res=>{
//					console.log(res.data.eventList)
